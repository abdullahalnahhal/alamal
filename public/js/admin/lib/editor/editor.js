...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			var row = $('<div/>',{
				"class":"row vtabs customvtab m-2"
			}).append($('<div/>',{
			...
			var chooseFromLocal = $('<input/>',{
				type: "file",
				class:"inline-form-control form-control",
				multiple: "multiple"
			});
			...
			}).appendTo($("<span/>", {class:"btn-group-right"}).appendTo(getImageURL));
