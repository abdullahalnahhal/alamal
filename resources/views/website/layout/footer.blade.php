                ...
                <div class="col-lg-6 footer_col text-{{getStyle(App::getLocale())['dir-full']}}" >
                    <div class="footer_newsletter">
                        ...
                        <form action="{{lRoute('subscribe')}}" method="post"  class="footer_newsletter_form">
                            @csrf
                            <input type="email" name="subscribe" class="footer_newsletter_input" placeholder="Your E-mail" required="required">
                        ...
                        <div class="footer_social">
                            <ul>
                                @if(\App\Contacts::googlePlus())
                                <li><a href="{{\App\Contacts::googlePlus()->value}}"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                                @endif
                                @if(\App\Contacts::googlePlus())
                                <li><a href="{{\App\Contacts::facebook()->value}}"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                @endif
                                @if(\App\Contacts::twitter())
                                <li><a href="{{\App\Contacts::facebook()->value}}"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                @endif
                                @if(\App\Contacts::youtube())
                                <li><a href="{{\App\Contacts::youtube()->value}}"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                @endif
                                @if(\App\Contacts::insta())
                                <li><a href="{{\App\Contacts::insta()->value}}"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                @endif
                                @if(\App\Contacts::linkedin())
                                <li><a href="{{\App\Contacts::linkedin()->value}}"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                @endif
