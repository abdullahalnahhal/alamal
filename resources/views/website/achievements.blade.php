...
@section('title', trans('website/header.Achievements'))
            ...
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-{{getStyle(App::getLocale())['dir-full']}}">
                        ...
                        <div class="section_title">@lang("website/header.Achievements")</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="point clearfix">
                        ...
                        <div class="point_content">
                            ...
                            <div class="point_text">
                                <p>
                                    {{str_limit($achievement->{'description_'.App::getLocale()}, 100, ' ...')}} 
                                    <div class="services_link">
                                        <a href="{{lRoute('achievements', ['id'=>$achievement->id])}}">@lang("website/all.more")</a>
                                    </div>
                                </p>
                            </div>
                        </div>
